                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                        ...
                        <div className="lg:col-span-2 space-y-16">
                            ...
                            {/* Syllabus/Modules */}
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900 mb-8 border-l-4 border-secondary pl-6">What You'll Learn</h2>
                            ...
                            <div className="bg-primary/5 p-12 rounded-3xl border border-primary/10">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div className="bg-white p-6 rounded-2xl shadow-sm">
                                        <h4 className="font-bold text-primary mb-3 text-lg">Hospitals</h4>
                                        <p className="text-gray-600">Work in Government and Private hospitals as a professional nurse.</p>
                                    </div>
                                    <div className="bg-white p-6 rounded-2xl shadow-sm">
                                        <h4 className="font-bold text-primary mb-3 text-lg">Community Health</h4>
                                        <p className="text-gray-600">Serve in specialized health centers and rural clinics.</p>
                                    </div>
                                    <div className="bg-white p-6 rounded-2xl shadow-sm">
                                        <h4 className="font-bold text-primary mb-3 text-lg">Private Clinics</h4>
                                        <p className="text-gray-600">Join specialized nursing homes or private medical practitioners.</p>
                                    </div>
                                    <div className="bg-white p-6 rounded-2xl shadow-sm">
                                        <h4 className="font-bold text-primary mb-3 text-lg">International Careers</h4>
                                        <p className="text-gray-600">Opportunities to work abroad with recognized certifications.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-8">
                            <div className="bg-white shadow-2xl rounded-3xl p-8 border border-gray-100 sticky top-32">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-900 font-bold">Full-Time / Regular</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 pt-8 border-t border-gray-100">
                                    <p className="text-sm text-gray-500 text-center mb-4 italic">Need more information?</p>
                                    <a href="tel:+918398093616" className="flex items-center justify-center text-primary font-bold">
                                        Call: +91 83980 93616
                                    </a>
                                </div>
                            </div>
...
const ANM = () => {
    return (
        <CoursePage
            title="ANM (Nursing)"
            subtitle="Auxiliary Nurse Midwifery - Laying the foundation for a clinical career."
            duration="2 Years"
            eligibility="10+2 from a recognized board"
            description="Auxiliary Nurse Midwifery (ANM) is a certificate-level course in the field of medical nursing. It focuses on the healthcare sector and provides students with knowledge about health care, equipment handling, and initial medical treatment of patients."
            tags={["Practical Training", "Certified Course", "Hospital Placement"]}
            content={[
                { title: "Fundamental Nursing", desc: "Understanding the basics of patient care and hospital ethics." },
                { title: "Community Health", desc: "Working with rural and urban communities for public health." },
                { title: "Primary Healthcare", desc: "Managing initial treatments and first aid procedures." },
                { title: "Midwifery Basics", desc: "Foundational knowledge in maternal and child healthcare." }
            ]}
        />
    );
};
